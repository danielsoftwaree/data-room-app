...
### Этап 9 — Auth Clerk — снят из скоупа

- [x] Осознанно не делаем: login-стена ломает «works out of the box». Зависимости удалены, трейд-офф зафиксирован в README, `docs/auth-clerk.md` переформулирован как forward-looking набросок (включая безтрениевый demo-путь, если auth когда-нибудь добавят).
